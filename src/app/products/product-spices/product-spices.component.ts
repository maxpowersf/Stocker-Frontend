...
@Component({
  selector: 'app-product-spices',
  templateUrl: './product-spices.component.html',
  styleUrls: ['./product-spices.component.css']
})
export class ProductSpicesComponent implements OnInit {
  ...
  getGroceriesList = () => {
    this.productService.getGroceryList(CategoryType.Spices).subscribe((res) => {
      this.products = res;
      this.groceriesForm = this.generateForm();
